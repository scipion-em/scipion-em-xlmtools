...
#  'Previous_stable_xml_version' + '_' + 'date_of_release_in_format_year+month+day'
# Example:
#  V_CB = '1.0_220111' (Stable version 1.0 and commit downloaded on the 05/01/2022)
COMMIT = '20e8e58'
V_CB = '1.0_220111'
